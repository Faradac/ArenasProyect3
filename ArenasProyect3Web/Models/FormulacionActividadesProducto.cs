...
{
    public partial class FormulacionActividadesProducto
    {
        public int IdActividadFormulacionProducto { get; set; }
        public string? CodigoFormulacion { get; set; }
        public int? IdLom { get; set; }
        public int? IdCoorelativo { get; set; }
        ...
        public virtual Correlativo? IdCoorelativoNavigation { get; set; }
        public virtual LineaXoperacionXmaquinarium? IdLomNavigation { get; set; }
