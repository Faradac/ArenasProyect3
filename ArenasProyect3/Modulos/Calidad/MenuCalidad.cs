...
{
    public partial class MenuCalidad : Form
    {
        //VARIABLES GENERALES
        ...
        private void MenuCalidad_Load(object sender, EventArgs e)
        {
        ...
        {
            this.panelPrincipalCalidad.Controls.Clear();
        ...
        //ABRIR EL MENÚ Y MANTENIMEINTO DE OP
        private void btnConsultaOP_Click(object sender, EventArgs e)
        {
            if (panelPrincipalCalidad.Controls.Count == 1)
            {
                panelPrincipalCalidad.Controls.Clear();
                AbrirFormularios(new Revision.MenuConsultasOP());
            }
            else
            {
                panelPrincipalCalidad.Controls.Clear();
        ...
        //ABRIR EL MENÚ Y MANTENIMIENTO DE REPORTES
