...
{
    public partial class MenuProduccion : Form
    {
        //VARIABLES GENERALES
        ...
        {
            this.panelPrincipaProduccion.Controls.Clear();
        ...
        private void btnConsultaOP_Click(object sender, EventArgs e)
        {
            if (panelPrincipaProduccion.Controls.Count == 1)
            {
                panelPrincipaProduccion.Controls.Clear();
                AbrirFormularios(new ConsultasOP.MenuConsultasOP());
            }
            else
            {
                panelPrincipaProduccion.Controls.Clear();
        ...
        public void AbrirFormularios(object formFormulario)
        {
            ...
            this.panelPrincipaProduccion.Controls.Add(frm);
            this.panelPrincipaProduccion.Tag = frm;
            frm.Show();
        }

        //BOTON DE TIEMPO DE PRODUCCION
        private void btnTiempoProduccion_MouseHover(object sender, EventArgs e)
        {
            btnTiempoProduccion.BackColor = Color.FromArgb(243, 243, 243);
        }

        //LEVANTAR MOUSE
        private void btnTiempoProduccion_MouseLeave(object sender, EventArgs e)
        {
            btnTiempoProduccion.BackColor = Color.White;
        }

        //BOTON DE CONSULTAS DE OP
        private void btnConsultaOP_MouseHover(object sender, EventArgs e)
        {
            btnConsultaOP.BackColor = Color.FromArgb(243, 243, 243);
        }

        //LEVANTAR MOUSE
        private void btnConsultaOP_MouseLeave(object sender, EventArgs e)
        {
            btnConsultaOP.BackColor = Color.White;
        }

        //BOTON DE CONSULTAS DE OT
        ...
        //BOTON DE REQUERIMIENTOS SIMPLES
